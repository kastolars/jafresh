...
private constructor() {
     ...
     */
    private val bytesToByteBuffer: MutableMap<ByteArray, ByteBuffer> = HashMap()
    //==============================================================================================
    // Builder
    //==============================================================================================
    /**
    ...
    private fun createCamera(): Camera {
        ...
        if (focusMode != null) {
            if (parameters.supportedFocusModes.contains(
                ...
                Log.i(
                    TAG, "Camera focus mode: " + focusMode +
        ...
        if (flashMode != null) {
            if (parameters.supportedFlashModes.contains(
                ...
                Log.i(
                    TAG, "Camera flash mode: " + flashMode +
                        " is not supported on this device.")
            }
        }
    ...
    companion object {
        ...
        private fun selectSizePair(camera: Camera, desiredWidth: Int, desiredHeight: Int): SizePair? {
            ...
            for (sizePair in validPreviewSizes) {
                ...
                val diff = abs(size.width - desiredWidth) +
                        abs(size.height - desiredHeight)
                if (diff < minDiff) {
